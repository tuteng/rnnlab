...
class LSTM(object):
    '''
    Long short-term memory graph in tensorflow
    '''
    ...
    def __init__(self, num_input_units, configs_dict):
        ...
        with tf.device(device):
            ...
            else: act='not implemented'
            cell = tf.nn.rnn_cell.BasicLSTMCell(num_hidden_units, activation=act, state_is_tuple=True)
            ########################################################################
